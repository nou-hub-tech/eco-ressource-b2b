...
import { EventEmitter, inject, Renderer2, ElementRef, Output, Input, Directive, NgZone, Injectable, LOCALE_ID, Pipe, Component, Injector, ViewContainerRef, DOCUMENT, HostListener, InjectionToken, NgModule, ChangeDetectorRef, afterNextRender } from '@angular/core';
...
class CalendarWeekViewCurrentTimeMarkerComponent {
    constructor() {
        ...
        this.marker$ = this.afterNextRender$.pipe(switchMap(() => interval(60 * 1000)), startWith(0), switchMap(() => this.columnDate$), map((columnDate) => {
