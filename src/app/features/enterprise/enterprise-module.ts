...
import { RESERVATION_WORKSPACE_ROUTES } from './reservation-workspace/reservation-workspace.routes';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'reservation-workspace',
        children: RESERVATION_WORKSPACE_ROUTES
      },
