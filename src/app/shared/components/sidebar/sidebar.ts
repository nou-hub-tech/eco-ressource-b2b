...
export class Sidebar implements OnInit {
  ...
  adminNav: NavItem[] = [
...

    {
      label: 'Bookings',
      icon: 'reservations',
      route: '/admin/reservations/bookings',
      badge: 'Watch'
    },

    {
      label: 'Spaces',
      icon: 'stock',
      route: '/admin/reservations/slots'
    },

    {
      label: 'Orders',
      icon: 'invoice',
      route: '/admin/reservations/orders'
    },
    ...
    { label: 'Events Calendar', icon: 'calendar', route: '/event-calendar' }
  ];
  ...
  enterpriseNav: NavItem[] = [
...

    {
      label: 'Bookings',
      icon: 'reservations',
      route: '/enterprise/reservation-workspace/reservations',
      badge: 'Dual'
    },
  ...
  transporterNav: NavItem[] = [
    ...
    { label: 'Delivery Orders', icon: 'listings', route: '/transporter/delivery-orders' }
  ];
