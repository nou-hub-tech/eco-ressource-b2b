...
function Stock_tr_36_button_22_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "button", 22);
    i0.ɵɵtext(1, "List Now");
    i0.ɵɵelementEnd();
} }
function Stock_tr_36_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(22, Stock_tr_36_button_22_Template, 2, 0, "button", 20);
...
function Stock_div_37_Template(rf, ctx) { if (rf & 1) {
    const _r2 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 23);
    i0.ɵɵlistener("click", function Stock_div_37_Template_div_click_0_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.closeModal()); });
    i0.ɵɵelementStart(1, "div", 24);
    i0.ɵɵlistener("click", function Stock_div_37_Template_div_click_1_listener($event) { return $event.stopPropagation(); });
    i0.ɵɵelementStart(2, "div", 25)(3, "h2");
    i0.ɵɵtext(4, "Add Product");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "button", 26);
    i0.ɵɵlistener("click", function Stock_div_37_Template_button_click_5_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.closeModal()); });
    i0.ɵɵtext(6, "\u2715");
    i0.ɵɵelementEnd()();
    ...
    i0.ɵɵlistener("click", function Stock_div_37_Template_button_click_46_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.closeModal()); });
    i0.ɵɵtext(47, "Cancel");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(48, "button", 3);
    i0.ɵɵlistener("click", function Stock_div_37_Template_button_click_48_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.closeModal()); });
...
export class Stock {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: Stock, selectors: [["app-stock"]], standalone: false, decls: 38, vars: 4, consts: [[1, "page-wrapper"], [1, "page-header-row"], [1, "page-header", 2, "margin", "0"], [1, "btn", "btn-primary", 3, "click"], [1, "toolbar"], [1, "search-box"], ["type", "text", "placeholder", "Search products...", 3, "ngModelChange", "ngModel"], [1, "spacer"], [1, "toolbar-count"], [1, "card", 2, "padding", "0"], [1, "data-table"], [4, "ngFor", "ngForOf"], ["class", "modal-overlay", 3, "click", 4, "ngIf"], [2, "color", "var(--text)"], [1, "badge", "badge-neutral"], [2, "color", "var(--text3)", "font-size", "11px"], [2, "color", "var(--text2)"], [1, "badge", 3, "ngClass"], [1, "ai-tip"], [2, "display", "flex", "gap", "6px"], ["class", "btn btn-primary btn-sm", 4, "ngIf"], [1, "btn", "btn-outline", "btn-sm"], [1, "btn", "btn-primary", "btn-sm"], [1, "modal-overlay", 3, "click"], [1, "modal", 3, "click"], [1, "modal-header"], [1, "btn", "btn-icon", 3, "click"], [1, "form-row"], [1, "form-group"], ["type", "text", "placeholder", "e.g. Aluminum Scrap"], ["type", "number", "placeholder", "0"], ["placeholder", "Describe the product..."], [1, "modal-footer"], [1, "btn", "btn-outline", 3, "click"]], template: function Stock_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵlistener("click", function Stock_Template_button_click_7_listener() { return ctx.openModal(); });
            ...
            i0.ɵɵtwoWayListener("ngModelChange", function Stock_Template_input_ngModelChange_13_listener($event) { i0.ɵɵtwoWayBindingSet(ctx.search, $event) || (ctx.search = $event); return $event; });
            i0.ɵɵelementEnd()();
            ...
            i0.ɵɵtemplate(36, Stock_tr_36_Template, 25, 9, "tr", 11);
            i0.ɵɵelementEnd()()()();
            i0.ɵɵtemplate(37, Stock_div_37_Template, 50, 0, "div", 12);
        } if (rf & 2) {
            i0.ɵɵadvance(13);
