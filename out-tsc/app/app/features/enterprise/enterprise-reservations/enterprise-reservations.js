...
function EnterpriseReservations_table_68_tr_16_button_17_Template(rf, ctx) { if (rf & 1) {
    const _r12 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 25);
    i0.ɵɵlistener("click", function EnterpriseReservations_table_68_tr_16_button_17_Template_button_click_0_listener($event) { i0.ɵɵrestoreView(_r12); const reservation_r11 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(2); ctx_r1.requestDelete(reservation_r11); return i0.ɵɵresetView($event.stopPropagation()); });
    i0.ɵɵtext(1, " Delete ");
    i0.ɵɵelementEnd();
} }
function EnterpriseReservations_table_68_tr_16_Template(rf, ctx) { if (rf & 1) {
    const _r10 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "tr", 49);
    i0.ɵɵlistener("click", function EnterpriseReservations_table_68_tr_16_Template_tr_click_0_listener() { const reservation_r11 = i0.ɵɵrestoreView(_r10).$implicit; const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.selectReservation(reservation_r11)); });
    i0.ɵɵelementStart(1, "td");
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "td");
    ...
    i0.ɵɵtext(11);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(12, "td", 51)(13, "button", 53);
    i0.ɵɵlistener("click", function EnterpriseReservations_table_68_tr_16_Template_button_click_13_listener($event) { const reservation_r11 = i0.ɵɵrestoreView(_r10).$implicit; const ctx_r1 = i0.ɵɵnextContext(2); ctx_r1.decide(reservation_r11, "CONFIRMED"); return i0.ɵɵresetView($event.stopPropagation()); });
    i0.ɵɵtext(14, " Accept ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(15, "button", 54);
    i0.ɵɵlistener("click", function EnterpriseReservations_table_68_tr_16_Template_button_click_15_listener($event) { const reservation_r11 = i0.ɵɵrestoreView(_r10).$implicit; const ctx_r1 = i0.ɵɵnextContext(2); ctx_r1.decide(reservation_r11, "REJECTED"); return i0.ɵɵresetView($event.stopPropagation()); });
    i0.ɵɵtext(16, " Reject ");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(17, EnterpriseReservations_table_68_tr_16_button_17_Template, 2, 0, "button", 52);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function EnterpriseReservations_table_68_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(13, "th");
    i0.ɵɵtext(14, "Decision");
    i0.ɵɵelementEnd()()();
    i0.ɵɵelementStart(15, "tbody");
    i0.ɵɵtemplate(16, EnterpriseReservations_table_68_tr_16_Template, 18, 11, "tr", 48);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(16);
...
function EnterpriseReservations_section_69_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(9, EnterpriseReservations_section_69_div_9_Template, 7, 3, "div", 56);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(10, "div", 57)(11, "strong");
    i0.ɵɵtext(12);
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(13, EnterpriseReservations_section_69_p_13_Template, 2, 1, "p", 58)(14, EnterpriseReservations_section_69_p_14_Template, 2, 0, "p", 58);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(6);
...
function EnterpriseReservations_div_70_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(6, "div", 38)(7, "button", 63);
...
export class EnterpriseReservations {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: EnterpriseReservations, selectors: [["app-enterprise-reservations"]], decls: 71, vars: 26, consts: [[1, "rc-page"], [1, "rc-hero", "card"], [1, "rc-kicker"], [1, "rc-subtitle"], [1, "rc-hero-stats"], [1, "rc-stat"], [1, "rc-stat", "warning"], [3, "action", "title", "subtitle", "insights"], [1, "card", "rc-toolbar"], [1, "search-box"], ["placeholder", "Company, machine, date, status", 3, "ngModelChange", "ngModel"], [1, "filter-select", 3, "ngModelChange", "ngModel"], ["value", "all"], ["value", "PENDING"], ["value", "CONFIRMED"], ["value", "REJECTED"], ["class", "btn btn-primary", "type", "button", 3, "click", 4, "ngIf"], ["class", "card", 4, "ngIf"], [1, "rc-grid"], [1, "card"], [1, "rc-section-head"], ["class", "rc-empty", 4, "ngIf"], ["class", "data-table", 4, "ngIf"], ["class", "modal-overlay", 3, "click", 4, "ngIf"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], ["type", "button", 1, "btn", "btn-outline", "btn-sm", 3, "click"], [1, "rc-form-grid"], [1, "form-group"], [3, "ngModelChange", "ngModel"], ["type", "number", 3, "ngModelChange", "ngModel"], ["type", "date", 3, "ngModelChange", "ngModel"], ["type", "number", "min", "0", "max", "23", 3, "ngModelChange", "ngModel"], ["type", "number", "min", "1", "max", "24", 3, "ngModelChange", "ngModel"], ["class", "form-group", 4, "ngIf"], [1, "rc-toggle"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], ["class", "alert alert-danger", 4, "ngIf"], ["class", "alert alert-success", 4, "ngIf"], [1, "rc-actions"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn-outline", 3, "click", "disabled"], [1, "alert", "alert-danger"], [1, "alert", "alert-success"], [1, "btn", "btn-outline", "btn-sm", 3, "routerLink"], [1, "rc-empty"], [1, "data-table"], [4, "ngFor", "ngForOf"], ["type", "button", 1, "btn", "btn-primary", "btn-sm", 3, "click"], [3, "click", 4, "ngFor", "ngForOf"], [3, "click"], [3, "label", "variant"], [1, "rc-row-actions"], ["class", "btn btn-outline btn-sm", "type", "button", 3, "click", 4, "ngIf"], ["type", "button", 1, "btn", "btn-primary", "btn-sm", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn-outline", "btn-sm", 3, "click", "disabled"], [1, "rc-timeline"], ["class", "rc-timeline-item", 4, "ngFor", "ngForOf"], [1, "rc-conflict-box"], [4, "ngIf"], [1, "rc-timeline-item"], [1, "rc-timeline-dot", 3, "ngClass"], [1, "modal-overlay", 3, "click"], [1, "modal", "rc-delete-modal", 3, "click"], ["type", "button", 1, "btn", "btn-danger", 3, "click", "disabled"]], template: function EnterpriseReservations_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtext(65);
            i0.ɵɵelementEnd()()();
            i0.ɵɵtemplate(66, EnterpriseReservations_div_66_Template, 2, 0, "div", 21)(67, EnterpriseReservations_div_67_Template, 2, 0, "div", 21)(68, EnterpriseReservations_table_68_Template, 17, 1, "table", 22);
            i0.ɵɵelementEnd()();
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(EnterpriseReservations, { className: "EnterpriseReservations", filePath: "src/app/features/enterprise/enterprise-reservations/enterprise-reservations.ts", lineNumber: 33 }); })();
